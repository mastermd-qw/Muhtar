...
import 'resturant_that_i_chose_riyadh_model.dart';
export 'resturant_that_i_chose_riyadh_model.dart';

class ResturantThatIChoseRiyadhWidget extends StatefulWidget {
  const ResturantThatIChoseRiyadhWidget({
    super.key,
    this.imagePath,
    this.resturantName,
  });
  ...
  @override
  State<ResturantThatIChoseRiyadhWidget> createState() =>
      _ResturantThatIChoseRiyadhWidgetState();
}

class _ResturantThatIChoseRiyadhWidgetState
    extends State<ResturantThatIChoseRiyadhWidget> {
  late ResturantThatIChoseRiyadhModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResturantThatIChoseRiyadhModel());
  }
