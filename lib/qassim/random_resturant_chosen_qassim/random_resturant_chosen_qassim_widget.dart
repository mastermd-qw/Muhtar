...
import 'random_resturant_chosen_qassim_model.dart';
export 'random_resturant_chosen_qassim_model.dart';

class RandomResturantChosenQassimWidget extends StatefulWidget {
  const RandomResturantChosenQassimWidget({
    super.key,
    this.imagePath,
    this.resturantName,
  });
  ...
  @override
  State<RandomResturantChosenQassimWidget> createState() =>
      _RandomResturantChosenQassimWidgetState();
}

class _RandomResturantChosenQassimWidgetState
    extends State<RandomResturantChosenQassimWidget> {
  late RandomResturantChosenQassimModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RandomResturantChosenQassimModel());
  }
